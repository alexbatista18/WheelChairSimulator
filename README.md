...
- O hardware necessário (cadeira instrumentada, encoders, etc.) está disponível no **INNELS** (Instituto Internacional de Neurociências de Natal Edmond e Lily Safra). Para acesso ao hardware ou mais informações sobre o dispositivo físico, procurar **Edgard Morya**.
...
- Autor: Alex Batista — dkalexbatista@gmail.com ([@alexbatista18](https://github.com/alexbatista18))
- Hardware (cadeira instrumentada, encoders): disponível no **INNELS**. Para mais informações, procurar **Edgard Morya**.
